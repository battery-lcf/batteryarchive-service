...
class ArchiveCellReader:
    ...
    def read_data(self, file_path):
        if self.tester == TESTER.ARBIN.value:
            data = read_arbin(file_path)
        if self.tester == TESTER.MACCOR.value:
            data = read_maccor(file_path)
        if self.tester == TESTER.ORNL.value:
            data = read_ornlabuse(file_path)
        if self.tester == TESTER.SNL.value:
            data = read_snlabuse(file_path)
    ...
    def read_data_from_archive(self):
        pass


class ArchiveCellWriter:
    def __init__(self):
        pass

    def write_cell_to_file(self, cell):
        pass

    def write_cell_to_archive(self):
        pass
